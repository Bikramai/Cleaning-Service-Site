(function ($) {
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index.html'><img src='/static/core/images/logos/logo.png' style='height: 80px;' alt='logo' class=''/></a></div>"
        });
    }
